...
const cards: CardConfig[] = [
  ...
  { key: 'documents', label: '知识', icon: <FileText className="h-5 w-5 text-orange-500" />, href: '/knowledge', hasTodayNew: true },
  { key: 'groups', label: '分组', icon: <Layers className="h-5 w-5 text-purple-500" />, href: '/knowledge', hasTodayNew: false },
];
