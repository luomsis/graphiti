...
from cli.constants import ALL_TABLES, EDGE_TABLES, IGNORED_FIELDS, NODE_TABLES
from cli.export import _build_query as _build_export_query

_ALL_TABLES = ALL_TABLES

_IGNORED_FIELDS = IGNORED_FIELDS
...
_NODE_TABLES = NODE_TABLES

_EDGE_TABLES = EDGE_TABLES
